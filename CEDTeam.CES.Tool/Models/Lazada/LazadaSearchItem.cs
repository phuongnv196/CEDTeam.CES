...
namespace CEDTeam.CES.Tool.Models.Lazada
{
    public class Item
    {
    ...
    public class UtTrack
    {
        public string from { get; set; }
    }

    public class BrandBar
    {
        public string tItemType { get; set; }
        public List<Item> items { get; set; }
        public UtTrack utTrack { get; set; }
    ...
    public class CampaignBanner
    {
        ...
        public UtTrack2 utTrack { get; set; }
        public string bizId { get; set; }
        public int? pos { get; set; }
    }
    ...
    public class Mods
    {
        public BrandBar brandBar { get; set; }
        public Filter filter { get; set; }
        public List<ListItem> listItems { get; set; }
        public List<Breadcrumb> breadcrumb { get; set; }
        public SortBar sortBar { get; set; }
        public BestShown bestShown { get; set; }
        public LazadaDecoration LazadaDecoration { get; set; }
        public CampaignBanner campaignBanner { get; set; }
    ...
    {
        public string categoryAsc { get; set; }
    ...
    {
        public string filterCheckedValues { get; set; }
    ...
    public class MainInfo
    {
        ...
        public string categoryRegionalKey { get; set; }
        public string mainCategoryRegionalKey { get; set; }
