...
namespace CEDTeam.CES.Infrastructure.Constants
{
    public class ApiConstant
    {
        ...
        public static class Lazada
        {
            ...
            public const string GET_PRODUCTS = LAZADA_BASE + "{0}?ajax=true&page={1}&style=list&rating=5";
        }
        ...
        public static class Sendo
        {
            ...
            public const string GET_PRODUCTS = "m/wap_v2/category/product?category_id={0}&listing_algo=algo5&p={1}&platform=web";
